        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            @csrf
                ...
                <div class="mb-5">
                    ...
                    <input type="password" name="password_confirmation" id="password_confirmation" minlength="8" placeholder="••••••••" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary1 focus:border-primary1 block w-full p-2.5" required>
                </div>
