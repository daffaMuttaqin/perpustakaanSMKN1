        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <input type="text" name="oldPassword" value="{{ $item->password }}" hidden>
                ...
                <div class="mb-5">
                    ...
                    <input type="password" name="password_confirmation" id="password_confirmation" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary1 focus:border-primary1 block w-full p-2.5" placeholder="Diisi jika ingin mengganti kata sandi">
                </div>
