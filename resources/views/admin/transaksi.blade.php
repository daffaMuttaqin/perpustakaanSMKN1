    ...
    <div class="flex items-center gap-x-24">        
        ...
        <form class="w-5/12 z-10">
            ...
            <div class="relative">
                ...
                <input type="search" name="title" id="default-search" class="block w-full p-3 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-white focus:ring-primary1" placeholder="Pencarian Transaksi">
            </div>
        </form>
    </div>
